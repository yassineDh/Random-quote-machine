...
class Quotebuttons extends Component {
    ...
    render(){
      return (
        <div >
          <button className="btn btn-primary shadow-none mr-3 float-left text-center" style={{backgroundColor:this.props.test,border:0,transition:'all 1s linear'}}><span><i className="fa fa-twitter"></i></span></button>
